...
public class CalculadorThread {
public static void main(String[] args) {
		
		JFrame janela = new JFrame("Multiplicação com Thread");
		...
		botao.addActionListener(new ActionButtonThread(primeiro, segundo, resultado));
